// NOTE: Intentional duplicate of mesh.frag. mesh.vert and mesh_skinned.vert
// share this fragment shader bit-for-bit (their `out` vars match exactly), but
// the engine's shader loader pairs <base>.vert + <base>.frag by filename. When
// you edit mesh.frag, mirror the change here.
